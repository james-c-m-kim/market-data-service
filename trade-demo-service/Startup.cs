    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.ConfigureSwaggerDocument(options =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Infusion Trade Demo Service",
                });
            ...
            services.AddTransient<IQuoteProvider, YahooFinancialDataProvider>();
            services.AddSingleton<MdsRepository>();
        }
